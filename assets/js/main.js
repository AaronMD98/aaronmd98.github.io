...
// let exitModal = function (modalClick) {
...
// Easier to just remove the class from all elements
modalClose.forEach((mc, i) => {
  mc.addEventListener("click", () => {
    modalView.forEach((mc) => mc.classList.remove("active-modal"));
  });
});
...
if (selectedTheme) {
  // if the validation is fulfilled, we ask what the issue was to know if we ctivated or deactivated the light
